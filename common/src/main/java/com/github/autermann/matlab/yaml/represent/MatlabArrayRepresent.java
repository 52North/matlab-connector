 ...
 */
public class MatlabArrayRepresent extends TypeSafeRepresent<MatlabArray> {

    public MatlabArrayRepresent(MatlabRepresenter delegate) {
        super(delegate, MatlabArray.class);
    }
